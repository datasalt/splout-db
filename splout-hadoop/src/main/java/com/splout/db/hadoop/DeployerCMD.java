...
public class DeployerCMD implements Tool {
	...
	@Parameter(names = { "-c", "--config-file" }, description = "Use the given filename as deployment spec. If present, <root> <tablespace> and <repfactor> options are ignored. In local filesystem.")
	...
	public int run(String[] args) throws Exception {
		...
		if (configFile != null) {
			...
			for (String tb : tablespaces) {
				...
				deployments.add(new TablespaceDepSpec(tb, tablespacePath.toString(), replicationFactor));				
			}
		}
