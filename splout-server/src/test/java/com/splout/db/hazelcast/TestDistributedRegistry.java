...
public class TestDistributedRegistry {
  ...
  /**
   * When split-brain, after merge, joining nodes must re-register themselves.
   * Checking.
   */
  @Test(timeout = 180000)
  public void testReregisterAfterMerge() throws Exception {
    ...
    List<String> clusterOneMembers = Arrays.asList("127.0.0.1:15701", "127.0.0.1:15702", "127.0.0.1:15703");
    ...
    /*
     * This simulates restoring a network connection between h4 and the other
     * cluster.
     */
  ...
  /**
   * When split-brain some members could have lost their registry information.
   * This test test that the checker works.
   */
  @Test
  ...
  /**
   * When split-brain some members could have lost their registry information.
   * This test test that if checker is disabled, it does not work.
   */
  @Test
  ...
  public void testChecking(final boolean enabledChecking) throws Exception {
    ...
    reg.register();
    // We call changeInfo, to check that the changeInfo is algo changing the in
