    ...
    for (; ; ) { // Fail-over loop
      ...
      try {
        ...
        if (tried == repEntry.getNodes().size()) {
          ...
          log.warn("TTransportException problem when connecting dnode[" + electedNode + "] at trial[" + tried + "] of[" + repEntry.getNodes().size() + "] DNodes. Will retry. Info: " + msg, e);
        }
        ...
        if (tried == repEntry.getNodes().size()) {
          ...
          log.warn("TException problem when connecting dnode[" + electedNode + "] at trial[" + tried + "] of[" + repEntry.getNodes().size() + "] DNodes. Will retry. Info: " + msg, e);
        }
      } catch (PoolCreationException e) {
        if (tried == repEntry.getNodes().size()) {
          return new ErrorQueryStatus("Error creating pool for dnode[" + electedNode + "] for " + msg);
        } else {
          log.warn("Error creating pool for dnode[" + electedNode + "] at trial[" + tried + "] of[" + repEntry.getNodes().size() + "] DNodes. Will retry. Info: " + msg, e);
        }
        ...
        if (tried == repEntry.getNodes().size()) {
          ...
          log.warn("Pool for dnode[" + electedNode + "] FULL! at trial[" + tried + "] of[" + repEntry.getNodes().size() + "] DNodes. Will retry. Info: " + msg, e);
        }
      } finally {
        if (client != null) {
